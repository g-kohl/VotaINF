...
import { AgendaItem, AgendaItemService } from "./agenda-item.service";
...
export class AgendaService {
  ...
  getAgendaItems(agendaId: number): Observable<AgendaItem[]> {
    let params = new HttpParams().set('agendaId', agendaId);
    return this.http.get<AgendaItem[]>(`${this.baseUrl}/agenda-items`, { params });
  }
}